...
class PrefUtil {
    companion object {
        ...
        private const val PREVIOUS_TIMER_LENGTH_SECONDS_ID = "com.esample.timerapp.previous_timer_length"
        ...
        fun setPreviousTimerLengthSeonds(seconds: Long, context: Context) {
